...
package oauth2 // import "github.com/spiffylabs/oauth2"
...
import (
	...
	"github.com/spiffylabs/net/context"
)

// Context can be an github.com/spiffylabs/net.Context, or an App Engine Context.
...
// on App Engine or not using github.com/spiffylabs/net.Context to provide a custom
...
// HTTPClient is the context key to use with github.com/spiffylabs/net/context's
